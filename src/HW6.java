...
public class HW6 {
    public static void main(String[] args) {
        ...
        WriteAndRead fileHandler = new WriteAndRead();
        String filePath = "cars.txt";


        fileHandler.writeCarsToFile(filePath, cars);


        List<String> carLines = fileHandler.readCarsToFile(filePath);
        System.out.println("Зчитані дані з файлу:");
        carLines.forEach(System.out::println);
